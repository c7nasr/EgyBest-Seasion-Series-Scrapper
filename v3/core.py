...
class EgybestLogic:
    ...
    def single_episode_info(self):
        ...
        self.driver = webdriver.Chrome(
            executable_path="/media/nasr/NASR/ME/Programming/Project/Python/spiders/EgyBest-spider/v2/chromedriver",
            ...
            while "&r" not in self.driver.current_url:
                ...
                while True:
                    try:
                        ...
                        self.driver.find_element_by_xpath(
                            f'//*[@id="video"]/div[4]/div[14]/div/ul/li[0]').click()
                        break
                    except:
                        self.driver.find_element_by_xpath(
                            '/html/body/div').click()
